...
namespace FlowCanvas
{
    ...
    public static class FlowGraphExtensions
    {
        ...
        //gx:添加监听bb参数变化
        public static ParameterVariableNode AddOnVariableChange(this FlowGraph graph, System.Type varType, IBlackboard bb, Variable variable, Vector2 pos, Port context, object dropInstance) {
            var genericType = typeof(OnVariableChange<>).MakeGenericType(varType);
            var node = (ParameterVariableNode)graph.AddNode(genericType, pos);
            node.parameter.SetTargetVariable(bb, variable);
            Finalize(node, context, dropInstance);
            return node;
        ...
        //添加menu缓存
        private static UnityEditor.GenericMenu s_cacheMenu;

        private static BoxClass<Vector2> s_cacheMousePos = new BoxClass<Vector2>();
        ...
        {
            s_cacheMousePos.value = mousePos;
            if (Prefs.UseAddNodeCacheNeedFix && s_cacheMenu != null && context == null) return s_cacheMenu;
            var menu = new UnityEditor.GenericMenu();
            if ( context is ValueOutput ) {
                menu = flowGraph.AppendTypeReflectionNodesMenu(menu, context.type, string.Empty, s_cacheMousePos, context, dropInstance);
            }
            if ( context is ValueInput ) {
                menu = flowGraph.AppendMakeVariableMenu(menu, string.Empty, s_cacheMousePos, context, dropInstance);
            }
            menu = flowGraph.AppendFlowNodesMenu(menu, string.Empty, s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendSimplexNodesMenu(menu, "Functions/Implemented", s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendAllReflectionNodesMenu(menu, "Functions/Reflected", s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendVariableNodesMenu(menu, "Variables", s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendSignals(menu, "Events/Signals", s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendMacroNodesMenu(menu, "MACROS", s_cacheMousePos, context, dropInstance);
            menu = flowGraph.AppendMenuCallbackReceivers(menu, string.Empty, s_cacheMousePos, context, dropInstance);
            if(Prefs.UseAddNodeCacheNeedFix && context == null) s_cacheMenu = menu;
            return menu;
        }
        ...
        //FlowNode
        public static UnityEditor.GenericMenu AppendFlowNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendSimplexNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendMakeVariableMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendAllReflectionNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendTypeReflectionNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, System.Type type, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendVariableNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
            if ( !string.IsNullOrEmpty(baseCategory) ) {
                baseCategory += "/";
            }
        ...
        public static UnityEditor.GenericMenu AppendMacroNodesMenu(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
        ...
        public static UnityEditor.GenericMenu AppendSignals(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
            var trackedAssets = AssetTracker.trackedAssets;
            if ( trackedAssets == null ) { return menu; }
        ...
        public static UnityEditor.GenericMenu AppendMenuCallbackReceivers(this FlowGraph graph, UnityEditor.GenericMenu menu, string baseCategory, BoxClass<Vector2> pos, Port contextPort, object dropInstance) {
