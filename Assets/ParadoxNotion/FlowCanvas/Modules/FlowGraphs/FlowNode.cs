...
namespace FlowCanvas
{
    ...
    abstract public partial class FlowNode : Node, ISerializationCallbackReceiver
    {
        ...
        public class GatherPortsCallbackAttributeDrawer : AttributeDrawer<GatherPortsCallbackAttribute>
        {
                ...
                if ( rect.Contains(e.mousePosition) ) {
                    ...
                    if ( dragDropMisses == graph.allNodes.Count && clickedPort != null ) {
                        ...
                        if ( zoomFactor >= 1 ) {
                            ...
                            // GenericMenuBrowser.Show(flowGraph.GetFullNodesMenu(mPos, cachePort, null), 
                            //     mPos, string.Format("Add & Connect (Type of {0})", cachePort.type.FriendlyName()), graph.baseNodeType);
                        } else {
                            EditorApplication.delayCall += () =>
                            {
                                ...
                                () => { return flowGraph.GetFullNodesMenu(mPos, cachePort, null); });
                                // GenericMenuBrowser.Show(flowGraph.GetFullNodesMenu(mPos, cachePort, null), 
                                // GraphEditorUtility.realMousePosition, string.Format("Add & Connect (Type of {0})", cachePort.type.FriendlyName()), graph.baseNodeType);
                            };
                        }
