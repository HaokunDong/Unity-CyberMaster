/*//例子，用于别的package中接入Log系统
using System;
using UnityEngine;
using Object = UnityEngine.Object;
using System.Diagnostics;

//命名空间要改为对应目录的命名空间，Channel默认值需要改为该Package专用的
namespace GameBase.Log.Extend
{
    public static class LogProxy
    {
        public delegate void LogDelegate(object log, int channel = 0, Color? color = null, Object context = null);
        //由项目Log系统调用
        ...
        [Conditional("FALSE")]
#endif
        public static void Trace(object log, int channel = 0, Color? color = null, Object context = null)
        {
        ...
        [Conditional("FALSE")]
#endif
        public static void Debug(object log, int channel = 0, Color? color = null, Object context = null)
        {
        ...
        [Conditional("FALSE")]
#endif
        public static void Warning(object log, int channel = 0, Color? color = null, Object context = null)
        {
        ...
        [Conditional("FALSE")]
#endif
        public static void Error(object log, int channel = 0, Color? color = null, Object context = null)
        {
